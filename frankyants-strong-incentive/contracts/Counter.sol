...
// TODO: Maybe don't set the contract_to_trigger address upon deployment,but rather PASS it TO CHECKUPKEEP CALL here 
// (I.E. YOUR APIConsumer contract address in checkData so it is triggered when upkeep is needed.)
    ...
    function performUpkeep(bytes calldata performData) external override {
        ...
        contractToCall.requestVolumeData();
